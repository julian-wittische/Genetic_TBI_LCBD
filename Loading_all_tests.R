...
#I_L1 <- TBI_test_auto_allp(rep = 180, path = "E:/Julian_simulations/I_L1/", scenario = 1)
...
#I_M1 <- TBI_test_auto_allp(rep = 180, path = "E:/Julian_simulations/I_M1/", scenario = 1)
...
#I_H1 <- TBI_test_auto_allp(rep = 180, path = "E:/Julian_simulations/I_H1/", scenario = 1)
